...
public class CacheManager {
  ...
  public static void putAll(Map<? extends String, ? extends String> map) {
    try {
      ...
      System.out.println("批量设置缓存值出错" + e);
    }
  }
  ...
  public static long size() {
    ...
    try {
      ...
      System.out.println("获取缓存项数量出错" + e);
    }
    return size;
  }
}